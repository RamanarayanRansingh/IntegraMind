...
INPUT_DATA_FILE = os.path.join(SCRIPT_DIR, 'batch_5_testdata.json')
OUTPUT_RESULTS_FILE = os.path.join(SCRIPT_DIR, 'batch_5_results.json')
DEBUG_OUTPUT_FILE = os.path.join(SCRIPT_DIR, 'batch_5_debug.json')
RATE_LIMIT_DELAY = 7
BATCH_NUM = 5

API_KEY = os.getenv("GOOGLE_API_KEY_5")
if not API_KEY:
    print(f"ERROR: GOOGLE_API_KEY_5 not found")
    sys.exit(1)
